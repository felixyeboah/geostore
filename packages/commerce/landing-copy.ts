...
export const LANDING_COPY = {
	hero: {
		...
		card: {
			eyebrow: "Portable performance for everyday work.",
	...
	gaming: {
		...
		title1: "Make room",
		title2: "for movie night.",
		subtitle1: "TVs and streaming devices for your home.",
		subtitle2: "Find the right screen for your space.",
		cta: "Explore this product",
		link: "Shop TVs and streaming",
		caption: "A closer look at your next screen.",
	},
	computing: {
