/* Screenshot + smoke-test helper for the landing mockups.
   usage: node design/landing-v4/_shoot.js <page.html> [width] [--test]
...
(async () => {
	...
	await p.goto(`http://localhost:8787/landing-v4/${page}`, { waitUntil: "networkidle", timeout: 30000 }).catch(async () => {
		await p.goto(`http://localhost:8787/landing-v4/${page}`, { waitUntil: "load" });
	});
