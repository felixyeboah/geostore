...
export function ReviewComposer({
	...
	const onSubmit = form.handleSubmit(async (values) => {
		...
		// Without an order item there is nothing to attach a verified-purchase
		// review to. Silently writing it to localStorage and flashing a success
		// badge would tell the customer their review was published when the
		// database never saw it.
		if (!orderItemId) {
			setServerError(
				"We couldn’t match this review to your order. Please contact support.",
			);
			return;
		}
